...
public class PvehiculoIncorrecto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pvehiculo_incorrecto);

        new Handler().postDelayed(() -> {
            Intent intent = new Intent(PvehiculoIncorrecto.this, PshowVehiculo.class);
